...
import pandas as pd
Features = pd.read_csv(r'C:\Users\Sai Rihitha\OneDrive\Desktop\mini\features.csv') # Read the entire DataFrame
...
print(Y.shape)
loaded_model=load_model(r'C:\Users\Sai Rihitha\OneDrive\Desktop\mini\my_model.h5')
def main1():
	r=sr.Recognizer()
...
def result():
    main1()
    features1=get_features(r'C:\Users\Sai Rihitha\OneDrive\Desktop\mini\recorded.wav') # Then save the file
